...
import { determineTeam, existsInSheet, isAdmin, isExec } from "../controllers/users";
...
// used to determine the team the exec is over
// export const getExecTeam: RequestHandler = async (req: Request, res: Response, next) => {
//     let bearer = req.headers.authorization;
